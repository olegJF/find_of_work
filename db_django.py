...
project_dir = os.path.dirname(os.path.abspath('db2.py'))
...
def scraping_sites():
    ...
    """
    specialties_in_each_city_dict = get_all_specialty_in_each_city()
    url_list = get_urls(specialties_in_each_city_dict)
    jobs = []
    for url in url_list:
        tmp = {}
        tmp_content = []
